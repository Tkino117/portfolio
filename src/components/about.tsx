		...
		<section>
			...
			<div className="grid gap-8 md:grid-cols-[1fr_auto]">
				<div className="space-y-4 text-base leading-relaxed">
					<p>
						北海道大学 工学部に所属しています。
						AI、3D、Web を横断する技術力を軸に、プロダクト開発から社会実装までを一貫して手がけてきました。
					</p>
					<p>
						代表的な活動として、森林 × IT プロジェクト「YAMAMORI（山守）」
						では研究リーダーを務めています。ドローン撮影から 3D Gaussian Splatting
						による森林デジタルツインの構築、樹木の個体解析から施業支援まで、北海道から九州まで現場に足を運びながら開発を推進しています。
					</p>
					<p>
